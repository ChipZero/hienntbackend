...
import com.hiennt.pizza.service.IProductService;
...
public class ProductController {
    ...
    boolean checkDataMissing(TblProduct product) throws HienntException {
    	if((product.getProName()==null || product.getProName()=="")||(product.getProUnitPrice()==null||product.getProUnitPrice()==0))
    		throw new HienntException(Errors.PRO_ERROR_EXISTS.getMessage(), Errors.PRO_ERROR_EXISTS.getId());
    	return true;
    }
}
